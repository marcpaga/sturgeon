...
fast5_folder="/var/lib/minknow/data/PMC_live_15/no_sample/20230420_1443_MN40017_FAV97131_b46744e9/fast5/" #to change
#fast5_folder="~/nanocns/data/pmc_live_first_6_fast5s/"

#define an output directory
main_folder = "~/nanocns/data/pmc_live_15"
...
while(running == T){
  ...
  for(f5 in fast5_cpy){
    ...
    if(iteration%in%CNV_iterations){
      ...
      try(plot_cnv_from_live_dir(main_folder), silent=T)
      dev.off()
